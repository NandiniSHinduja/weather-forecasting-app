...
public class Chennai14 extends AppCompatActivity {
    TextView Date;
    TextView MaxTemp;
    TextView Head;
    TextView Humidity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chennai14);
        setTitle("Birla Planetarium");
    ...
    private void get_main() {
        ...
        String url="https://api.weatherapi.com/v1/forecast.json?key=9ef0030383af453f9d0171034212003&q=kotturpuram&days=2";
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Main.setText(main);
                            Glide.with(Chennai14.this).load(iconUrl).into(img);
                            ...
                            Main1.setText(main1);
                            Glide.with(Chennai14.this).load(iconUrl1).into(img1);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Chennai14.this, error.toString(),Toast.LENGTH_LONG).show();
