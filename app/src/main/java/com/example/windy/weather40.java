...
public class weather40 extends AppCompatActivity {
    TextView Date;
    TextView MaxTemp;
    TextView Head;
    TextView Humidity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Details");
        setContentView(R.layout.weather40);
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            JSONObject object=array.getJSONObject(39);
                            ...
                            Glide.with(weather40.this).load(iconUrl).into(img);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(weather40.this, error.toString(),Toast.LENGTH_LONG).show();
