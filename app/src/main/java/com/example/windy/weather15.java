...
public class weather15 extends AppCompatActivity {
    TextView Date;
    TextView MaxTemp;
    TextView Head;
    TextView Humidity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Details");
        setContentView(R.layout.weather15);
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            JSONObject object=array.getJSONObject(14);
                            ...
                            Glide.with(weather15.this).load(iconUrl).into(img);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(weather15.this, error.toString(),Toast.LENGTH_LONG).show();
