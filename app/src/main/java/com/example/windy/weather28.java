...
public class weather28 extends AppCompatActivity {
    TextView Date;
    TextView MaxTemp;
    TextView Head;
    TextView Humidity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Details");
        setContentView(R.layout.weather28);
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            JSONObject object=array.getJSONObject(27);
                            ...
                            Glide.with(weather28.this).load(iconUrl).into(img);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(weather28.this, error.toString(),Toast.LENGTH_LONG).show();
