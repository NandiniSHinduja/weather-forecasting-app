...
public class weather6 extends AppCompatActivity {
    TextView Date;
    TextView MaxTemp;
    TextView Head;
    TextView Humidity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Details");
        setContentView(R.layout.weather6);
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Glide.with(weather6.this).load(iconUrl).into(img);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(weather6.this, error.toString(),Toast.LENGTH_LONG).show();
