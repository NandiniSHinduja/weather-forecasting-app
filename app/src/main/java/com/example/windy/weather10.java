...
public class weather10 extends AppCompatActivity {
    TextView Date;
    TextView MaxTemp;
    TextView Head;
    TextView Humidity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Details");
        setContentView(R.layout.weather10);
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Glide.with(weather10.this).load(iconUrl).into(img);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(weather10.this, error.toString(),Toast.LENGTH_LONG).show();
