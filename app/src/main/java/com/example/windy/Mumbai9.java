...
public class Mumbai9 extends AppCompatActivity {
    TextView Date;
    TextView MaxTemp;
    TextView Head;
    TextView Humidity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mumbai9);
        setTitle("Chota Kashmir");
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Main.setText(main);
                            Glide.with(Mumbai9.this).load(iconUrl).into(img);
                            ...
                            Main1.setText(main1);
                            Glide.with(Mumbai9.this).load(iconUrl1).into(img1);
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Mumbai9.this, error.toString(),Toast.LENGTH_LONG).show();
